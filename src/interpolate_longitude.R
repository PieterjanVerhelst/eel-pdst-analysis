...
input1 <- data.frame(seq(as.Date("2019/11/19"), as.Date("2020/09/18"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(12.299493, 9.703494, length.out = 305)
...
input1$Quality <- 5
input1$Quality[1] <- 0
input1$Quality[305] <- 0


# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17471/EELA17471LONG.csv", row.names = FALSE)
