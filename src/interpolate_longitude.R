...
input1 <- data.frame(seq(as.Date("2019/12/14"), as.Date("2020/01/24"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.76, -0.86, length.out = 42)
...
# Write csv file
write.csv(input1, "./data/interim/input_A17513/EELA17513LONG.csv", row.names = FALSE)
