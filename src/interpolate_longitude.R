...
input1 <- data.frame(seq(as.Date("2020/12/24"), as.Date("2021/06/05"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, 1.581665, length.out = 164)
...
input1$Quality <- 5
input1$Quality[1] <- 0
input1$Quality[164] <- 0


# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17521_2/EELA17521LONG.csv", row.names = FALSE)
