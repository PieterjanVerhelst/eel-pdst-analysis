...
input1 <- data.frame(seq(as.Date("2018/12/09"), as.Date("2019/03/23"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.76, -2.23, length.out = 105)
...
input1$Quality <- 5
input1$Quality[1] <- 0
input1$Quality[105] <- 0


# Write csv file
write.csv(input1, "./data/interim/input_A15700/EELA15700LONG.csv", row.names = FALSE)
