...
input1 <- data.frame(seq(as.Date("2020/12/24"), as.Date("2021/02/15"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, -0.270559, length.out = 54)
...
# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17547/EELA17547LONG.csv", row.names = FALSE)
