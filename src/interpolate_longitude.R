...
input1 <- data.frame(seq(as.Date("2018/10/31"), as.Date("2019/05/19"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.76, 2.65, length.out = 201)
...
input1$Quality <- 5
input1$Quality[1] <- 0
input1$Quality[201] <- 0


# Write csv file
write.csv(input1, "./data/interim/input_A15736/EELA15736LONG.csv", row.names = FALSE)
