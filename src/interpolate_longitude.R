...
input1 <- data.frame(seq(as.Date("2019/12/17"), as.Date("2020/02/15"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, -12.7, length.out = 61)
...
# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A15789/EELA15789LONG.csv", row.names = FALSE)
