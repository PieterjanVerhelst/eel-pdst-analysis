...
input1 <- data.frame(seq(as.Date("2019/12/10"), as.Date("2020/01/19"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.76, 5.22, length.out = 41)
...
# Write csv file
write.csv(input1, "./data/interim/input_A17528/EELA17528LONG.csv", row.names = FALSE)
