...
input1 <- data.frame(seq(as.Date("2020/12/25"), as.Date("2021/08/07"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, -0.169593, length.out = 226)
...
input1$Quality <- 5
input1$Quality[1] <- 0
input1$Quality[226] <- 0


# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17449/EELA17449LONG.csv", row.names = FALSE)
