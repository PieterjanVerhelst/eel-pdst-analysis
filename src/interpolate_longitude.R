...
input1 <- data.frame(seq(as.Date("2020/12/06"), as.Date("2021/04/10"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, -4.547764, length.out = 126)
...
input1$Quality <- 5
input1$Quality[1] <- 0
input1$Quality[126] <- 0


# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17663/EELA17663LONG.csv", row.names = FALSE)
