...
input1 <- data.frame(seq(as.Date("2020/12/25"), as.Date("2021/02/19"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, -5.6421, length.out = 57)
...
# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17487/EELA17487LONG.csv", row.names = FALSE)
