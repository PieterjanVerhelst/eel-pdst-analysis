...
input1 <- data.frame(seq(as.Date("2020/11/21"), as.Date("2021/02/19"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(2.757437, -2.71248908132952, length.out = 91)
...
# Write csv file
write.csv(input1, "./data/interim/geolocation_input_files/input_A17652/EELA17652LONG.csv", row.names = FALSE)
