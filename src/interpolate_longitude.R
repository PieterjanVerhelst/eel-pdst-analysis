...
input1 <- data.frame(seq(as.Date("2012/11/14"), as.Date("2012/12/18"), "days")) # take day before retrieval, since exact moment of retrieval is unknown
colnames(input1)[1] <- "Date/Time Stamp"


# Interpolate between longitude of release and retrieval location
input1$Long <- seq(9.699569, 0.700017, length.out = 35)
...
# Write csv file
write.csv(input1, "./data/interim/input_A09374/EELA09374LONG.csv", row.names = FALSE)
