...
release <- "2018-12-04 13:00:00"
retrieval <- "2019-01-21 23:55:00"  # Take day before retrieval, since exact moment of retrieval is unknown
...
subset2 <- filter(aggdata, datetime2 == "2018-12-04 12:45:00" | datetime2 == "2019-01-19 23:55:00")
...
press$regression <- (5.522e-07   *press$numericdate)     -8.523e+02
