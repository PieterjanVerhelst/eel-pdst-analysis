...
subset2 <- filter(aggdata, datetime2 == "2018-12-04 12:45:00" | datetime2 == "2019-01-18 23:55:00")
...
press$regression <- ( 6.237e-07   *press$numericdate)    -9.628e+02  
