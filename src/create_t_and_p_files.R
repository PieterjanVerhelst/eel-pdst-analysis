...
subset2 <- filter(aggdata, datetime2 == "2018-11-11 12:00:00" | datetime2 == "2018-11-30 23:55:00")
...
press$regression <- (1.504e-06 *press$numericdate)   -2.319e+03
