...
sensordata <- read_csv("./data/interim/sensorlogs/sensor_A17477_03-07-2020.csv")
...
retrieval <- as.POSIXct("2020-05-31 23:59:00", "%Y-%m-%d %H:%M:%S", tz = "GMT") # Take day before retrieval, since exact moment of retrieval is unknown
pop <- as.POSIXct("2020-03-24 13:03:00", "%Y-%m-%d %H:%M:%S", tz = "GMT")
...
subset <- filter(aggdata, datetime >= "2020-03-24 00:00:00", datetime <= "2020-03-25 00:00:00")
