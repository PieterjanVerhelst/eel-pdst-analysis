...
release <- as.POSIXct("2020-12-04 11:10:00", "%Y-%m-%d %H:%M:%S", tz = "GMT")
...
pop <- as.POSIXct("2021-01-14 06:25:00", "%Y-%m-%d %H:%M:%S", tz = "GMT")
...
subset <- filter(aggdata, datetime >= "2021-01-14 00:00:00", datetime <= "2021-01-15 00:00:00")
