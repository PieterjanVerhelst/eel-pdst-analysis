...
temp_data <- read_csv("./data/interim/geolocation_input_files/input_A17538_2/EELA17538TEMP.csv")
press_data <- read_csv("./data/interim/geolocation_input_files/input_A17538_2/EELA17538PRES.csv")
...
# 4. Write csv files ####
write.csv(input_sst, "./data/interim/geolocation_input_files/input_A17538_2/EELA17538TEMP_F.csv", na = "NaN", row.names = FALSE)
