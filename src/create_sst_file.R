...
temp_data <- read_csv("./data/interim/geolocation_input_files/input_A15789/EELA15789TEMP.csv")
press_data <- read_csv("./data/interim/geolocation_input_files/input_A15789/EELA15789PRES.csv")
...
# 4. Write csv files ####
write.csv(input_sst, "./data/interim/geolocation_input_files/input_A15789/EELA15789TEMP_F.csv", na = "NaN", row.names = FALSE)
