...
temp_data <- read_csv("./data/interim/geolocation_input_files/input_A17547/EELA17547TEMP.csv")
press_data <- read_csv("./data/interim/geolocation_input_files/input_A17547/EELA17547PRES.csv")
...
# 4. Write csv files ####
write.csv(input_sst, "./data/interim/geolocation_input_files/input_A17547/EELA17547TEMP_F.csv", na = "NaN", row.names = FALSE)
