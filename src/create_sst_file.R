...
temp_data <- read_csv("./data/interim/input_A15736/EELA15736TEMP.csv")
press_data <- read_csv("./data/interim/input_A15736/EELA15736PRES.csv")
...
# 4. Write csv files ####
write.csv(input_sst, "./data/interim/input_A15736/EELA15736TEMP_F.csv", na = "NaN", row.names = FALSE)
